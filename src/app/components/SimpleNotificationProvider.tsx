...
function NotificationToast() {
  ...
  const getColorForType = (type: string) => {
    switch (type) {
      case 'success':
        return 'bg-green-50 border-green-200 text-green-800 !important';
      case 'info':
        return 'bg-blue-50 border-blue-200 text-blue-800 !important';
      case 'warning':
        return 'bg-yellow-50 border-yellow-200 text-yellow-800 !important';
      case 'error':
        return 'bg-red-50 border-red-200 text-red-800 !important';
      default:
        return 'bg-gray-50 border-gray-200 text-gray-800 !important';
    }
  };
